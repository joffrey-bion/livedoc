...
public class SpringConsumesBuilder {
    ...
    /**
     * From Spring's documentation: [consumes is] supported at the type level as well as at the method level! When used
     * at the type level, all method-level mappings override this consumes restriction.
     *
     * @param method
     *
     * @return
