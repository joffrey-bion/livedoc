package org.hildan.livedoc.core.scanner.validator;
...
public class JSONDocApiMethodDocValidator {
    ...
    public static ApiMethodDoc validateApiMethodDoc(ApiMethodDoc apiMethodDoc, MethodDisplay displayMethodAs) {
        ...
        final String HINT_MISSING_METHOD_RESPONSE_OBJECT = "Add annotation ApiResponseObject to document the returned"
                + " object";
        final String HINT_MISSING_METHOD_SUMMARY = "Method display set to SUMMARY, but summary info has not been "
                + "specified";
